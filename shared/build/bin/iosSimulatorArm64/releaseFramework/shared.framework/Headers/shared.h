...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getAllNotesId:(int64_t)id completionHandler:(void (^)(NSArray<SharedNote *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getAllNotes(id:completionHandler:)")));
...
- (int64_t)toEpochMillSecDateTime:(SharedKotlinx_datetimeLocalDateTime *)dateTime __attribute__((swift_name("toEpochMillSec(dateTime:)")));
@end;
...
- (int64_t)generateRandomColors __attribute__((swift_name("generateRandomColors()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchNote")))
@interface SharedSearchNote : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
